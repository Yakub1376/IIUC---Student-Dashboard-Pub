...
public class ResultViewTableAdapter extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    public void onBindCellViewHolder(@NonNull AbstractViewHolder holder, @Nullable Cell cellItemModel, int columnPosition, int rowPosition) {
        ...
        ResultViewTableAdapter.MyCellViewHolder viewHolder = (ResultViewTableAdapter.MyCellViewHolder) holder;
...
//--------------------------------------------- Create a ColumnHeader ViewHolder---------------------------------------
        return new ResultViewTableAdapter.MyColumnHeaderViewHolder(layout);
    }
...
//------------------------------------------------ Get the holder to update cell item text--------------------------------------------------
        ResultViewTableAdapter.MyColumnHeaderViewHolder columnHeaderViewHolder = (ResultViewTableAdapter.MyColumnHeaderViewHolder) holder;
...
//------------------------------------- Get the holder to update row header item text---------------------------------------------------
        ResultViewTableAdapter.MyRowHeaderViewHolder rowHeaderViewHolder = (ResultViewTableAdapter.MyRowHeaderViewHolder) holder;
